...
import ShowCart from '../cart/showcart';
  ...
  const Product = ({ addToCart, showCart }) => {
    ...
    return (
      <>
        <div>
          <Filter filters={filters} setFilters={setFilters} products={products} setProducts={setProducts} />
                  ...
                  <Card className={`product-card mb-3 ${product.expanded ? 'expanded-card' : ''}`}>
                    ...
                    <Card.Body>
                      ...
                      <Button variant="primary" onClick={() => {
                        addToCart(product);
                        console.log('Producto agregado al carrito por el boton: ', product.id + product.nombre + product.imagen + product.descripcion);
                      }}>
                        Agregar al carrito
                      </Button>
                    </Card.Body>
